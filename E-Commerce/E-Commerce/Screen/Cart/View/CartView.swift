...
extension CartView {
    ...
    private func addSubview() {
        let productCollectionLayout = UICollectionViewFlowLayout()
        productCollectionLayout.sectionInset = UIEdgeInsets(top: 0, left: 0, bottom: 130, right: 0)
        cartCollection = CustomCollection(backgroundColor: .systemGray6, showsScrollIndicator: false ,layout: productCollectionLayout, scrollDirection: .vertical)
